...
def play():
    button1 = Button(root,height=13,width=28,bd=.5,relief = 'ridge',bg = '#f2e6ff',textvariable = btn1,
                     command=lambda: press(1,0,0))
    button1.grid(row=0,column=0)

    button2 = Button(root,height=13,width=28,bd = .5,relief = 'ridge',bg = '#f2e6ff',textvariable = btn2,
                     command=lambda: press(2,0,1))
    button2.grid(row=0,column=1)

    button3 = Button(root,height=13,width=28,bd = .5,relief = 'ridge',bg = '#f2e6ff',textvariable = btn3,
                     command=lambda: press(3,0,2))
    button3.grid(row=0,column=2)

    button4 = Button(root,height=13,width=28,bd = .5,relief = 'ridge',bg = '#f2e6ff',textvariable = btn4,
                     command=lambda: press(4,1,0))
    button4.grid(row=1,column=0)

    button5 = Button(root,height=13,width=28,bd = .5,relief = 'ridge',bg = '#f2e6ff',textvariable = btn5,
                     command=lambda: press(5,1,1))
    button5.grid(row=1,column=1)

    button6 = Button(root,height=13,width=28,bd = .5,relief = 'ridge',bg = '#f2e6ff',textvariable = btn6,
                     command=lambda: press(6,1,2))
    button6.grid(row=1,column=2)

    button7 = Button(root,height=13,width=28,bd = .5,relief = 'ridge',bg = '#f2e6ff',textvariable = btn7,
                     command=lambda: press(7,2,0))
    button7.grid(row=2,column=0)

    button8 = Button(root,height=13,width=28,bd = .5,relief = 'ridge',bg = '#f2e6ff',textvariable = btn8,
                     command=lambda: press(8,2,1))
    button8.grid(row=2,column=1)

    button9 = Button(root,height=13,width=28,bd = .5,relief = 'ridge',bg = '#f2e6ff',textvariable = btn9,
